export default function QualityAssuranceCourseDetails() {
    return (
        <div className="container">
            ...
            <div className="course-card">
                ...
                <a href="details/add-course-objective" className="custom-button">Add Course Objective</a>
                ...
                <div className="table-container">
                    <table className="performance-table">
                        ...
                        <tr>
                            <td>Exam 1</td>
                            <td>2023-09-15</td>
                            <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed nec varius quam. Maecenas id erat vitae tortor viverra congue. In hac habitasse platea dictumst. Nulla eu sapien vel risus vehicula scelerisque.</td>
                        </tr>
                        <tr>
                            <td>Exam 3</td>
                            <td>2023-09-15</td>
